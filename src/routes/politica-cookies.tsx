...
export const Route = createFileRoute("/politica-cookies")({
  head: () =>
    buildSeo({
      title: `Política de Cookies | ${SITE.name} Madrid`,
      description: `Información sobre el uso de cookies en StopCars Madrid.`,
...
function CookiesPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 md:px-6">
      ...
      <h1 className="mt-3 font-display text-4xl font-black md:text-5xl">Política de Cookies</h1>
