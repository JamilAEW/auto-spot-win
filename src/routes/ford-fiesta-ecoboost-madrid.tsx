...
export const Route = createFileRoute("/ford-fiesta-ecoboost-madrid")({
  head: () =>
    buildSeo({
      title: `Ford Fiesta EcoBoost Madrid | ${SITE.name} Madrid`,
      description: `Cambio correa húmeda Ford Fiesta EcoBoost 1.0 en Madrid. Especialistas en wet belt.`,
      path: "/ford-fiesta-ecoboost-madrid",
    }),
  component: FordFiestaPage,
});

function FordFiestaPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 md:px-6">
      <p className="font-display text-xs font-bold uppercase tracking-[0.2em] text-primary">En construcción</p>
      <h1 className="mt-3 font-display text-4xl font-black md:text-5xl">Ford Fiesta EcoBoost Madrid</h1>
