...
export const Route = createFileRoute("/blog/traqueteo-arranque-puretech")({
  head: () =>
    buildSeo({
      title: `Traqueteo al arrancar PureTech | ${SITE.name} Madrid`,
      description: `Diagnóstico del traqueteo en frío en motores PureTech.`,
...
function Post8() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 md:px-6">
      ...
      <h1 className="mt-3 font-display text-4xl font-black md:text-5xl">Traqueteo al arrancar PureTech</h1>
