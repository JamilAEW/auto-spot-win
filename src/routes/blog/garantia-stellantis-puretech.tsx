...
export const Route = createFileRoute("/blog/garantia-stellantis-puretech")({
  head: () =>
    buildSeo({
      title: `Garantía Stellantis PureTech | ${SITE.name} Madrid`,
      description: `Cómo reclamar la garantía extendida del motor PureTech.`,
...
function Post5() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 md:px-6">
      ...
      <h1 className="mt-3 font-display text-4xl font-black md:text-5xl">Garantía Stellantis PureTech</h1>
