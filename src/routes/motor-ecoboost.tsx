...
export const Route = createFileRoute("/motor-ecoboost")({
  head: () =>
    buildSeo({
      title: `Motor EcoBoost | ${SITE.name} Madrid`,
      description: `Cambio de correa húmeda Ford EcoBoost 1.0 en Madrid. Diagnóstico gratuito, garantía 12 meses.`,
      path: "/motor-ecoboost",
    }),
  component: MotorEcoboostPage,
});

function MotorEcoboostPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 md:px-6">
      <p className="font-display text-xs font-bold uppercase tracking-[0.2em] text-primary">En construcción</p>
      <h1 className="mt-3 font-display text-4xl font-black md:text-5xl">Motor EcoBoost</h1>
