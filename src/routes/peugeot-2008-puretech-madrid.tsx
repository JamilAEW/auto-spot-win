...
export const Route = createFileRoute("/peugeot-2008-puretech-madrid")({
  head: () => {
    ...
    return {
      ...buildSeo({
        title: "Cambio Correa Peugeot 2008 PureTech Madrid | 999 € | StopCars",
        description: "Taller especialista en Peugeot 2008 PureTech 1.2 en Madrid. Cambio de correa de distribución sumergida con kit Dayco reforzado por 999 € con IVA y mano de obra. Garantía 24 meses. Entrega el mismo día.",
        path: `/${SLUG}`,
      }),
      scripts: [
