...
export const Route = createFileRoute("/peugeot-308-puretech-madrid")({
  head: () => {
    ...
    return {
      ...buildSeo({
        title: "Cambio Correa Peugeot 308 PureTech Madrid | 399 € | StopCars",
        description: "Taller especialista en Peugeot 308 PureTech 1.2 en Madrid. Cambio de correa de distribución sumergida con kit Dayco reforzado por 399 € con IVA y mano de obra. Garantía 24 meses. Entrega el mismo día.",
        path: `/${SLUG}`,
      }),
      scripts: [
