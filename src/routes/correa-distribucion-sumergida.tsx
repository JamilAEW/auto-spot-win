...
export const Route = createFileRoute("/correa-distribucion-sumergida")({
  head: () =>
    buildSeo({
      title: `Correa Distribución Sumergida | ${SITE.name} Madrid`,
      description: `Todo sobre la correa de distribución bañada en aceite (wet belt): qué es, riesgos y mantenimiento.`,
      path: "/correa-distribucion-sumergida",
    }),
  component: CorreaWetBeltPage,
});

function CorreaWetBeltPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 md:px-6">
      <p className="font-display text-xs font-bold uppercase tracking-[0.2em] text-primary">En construcción</p>
      <h1 className="mt-3 font-display text-4xl font-black md:text-5xl">Correa Distribución Sumergida</h1>
