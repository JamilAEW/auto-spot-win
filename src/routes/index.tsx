        ...
        <div className="relative mx-auto max-w-7xl px-4 py-6 md:px-6 md:py-10 lg:py-12">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div>
              ...
              <h1 className="font-display font-black uppercase leading-[1.05] text-foreground">
                <span className="block text-xl font-bold text-foreground/80 md:text-2xl lg:text-3xl">Especialistas en</span>
                <span className="mt-1 block text-4xl text-primary md:text-6xl lg:text-7xl">Correa de Distribución Sumergida</span>
                <span className="mt-1 block text-xl font-bold text-foreground/80 md:text-2xl lg:text-3xl">en Madrid</span>
              </h1>
