...
const SLUG = "ds3-puretech-madrid";
...
export const Route = createFileRoute("/ds3-puretech-madrid")({
  head: () => {
    ...
    return {
      ...buildSeo({
        title: "Cambio Correa DS3 PureTech Madrid | 399 € | StopCars",
        description: "Taller especialista en DS3 PureTech 1.2 en Madrid. Cambio de correa de distribución sumergida con kit Dayco reforzado por 399 € con IVA y mano de obra. Garantía 12 meses. Entrega el mismo día.",
        path: `/${SLUG}`,
      }),
      scripts: [
