  ...
  head: () => {
    ...
    return {
      ...buildSeo({
        ...
        description: "Taller especialista en Ford EcoSport EcoBoost 1.0 en Madrid. Cambio de correa de distribución sumergida con kit Dayco reforzado y bomba de agua incluida. 2 días de trabajo. Garantía 24 meses.",
        path: `/${SLUG}`,
      }),
      scripts: [
