...
export const Route = createFileRoute("/ford-ecosport-ecoboost-madrid")({
  head: () => {
    ...
    return {
      ...buildSeo({
        title: "Cambio Correa Ford EcoSport EcoBoost Madrid | 399 € | StopCars",
        description: "Taller especialista en Ford EcoSport EcoBoost 1.0 en Madrid. Cambio de correa de distribución sumergida con kit Dayco reforzado por 399 € con IVA y mano de obra. Garantía 12 meses. Entrega el mismo día.",
        path: `/${SLUG}`,
      }),
      scripts: [
