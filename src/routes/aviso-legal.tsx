...
export const Route = createFileRoute("/aviso-legal")({
  head: () =>
    buildSeo({
      title: `Aviso Legal | ${SITE.name} Madrid`,
      description: `Información legal de StopCars Madrid.`,
      path: "/aviso-legal",
    }),
...
function AvisoLegalPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 md:px-6">
      ...
      <h1 className="mt-3 font-display text-4xl font-black md:text-5xl">Aviso Legal</h1>
