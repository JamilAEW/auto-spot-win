...
export const Route = createFileRoute("/opel-corsa-puretech-madrid")({
  head: () => {
    ...
    return {
      ...buildSeo({
        title: "Cambio Correa Opel Corsa PureTech Madrid | 999 € | StopCars",
        description: "Taller especialista en Opel Corsa PureTech 1.2 en Madrid. Cambio de correa de distribución sumergida con kit Dayco reforzado por 999 € con IVA y mano de obra. Garantía 24 meses. Entrega el mismo día.",
        path: `/${SLUG}`,
      }),
      scripts: [
