...
const SLUG = "opel-grandland-puretech-madrid";
...
export const Route = createFileRoute("/opel-grandland-puretech-madrid")({
  head: () => {
    ...
    return {
      ...buildSeo({
        title: "Cambio Correa Opel Grandland PureTech Madrid | 399 € | StopCars",
        description: "Taller especialista en Opel Grandland PureTech 1.2 en Madrid. Cambio de correa de distribución sumergida con kit Dayco reforzado por 399 € con IVA y mano de obra. Garantía 12 meses. Entrega el mismo día.",
        path: `/${SLUG}`,
      }),
      scripts: [
